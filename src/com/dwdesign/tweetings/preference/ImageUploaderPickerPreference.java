...
public class ImageUploaderPickerPreference extends DialogPreference implements Constants, OnClickListener {
	...
	public void onPrepareDialogBuilder(final AlertDialog.Builder builder) {
		...
		specs.add(new ImageUploaderSpec(getContext().getString(R.string.image_uploader_twitpic), "twitpic"));
		specs.add(new ImageUploaderSpec(getContext().getString(R.string.image_uploader_yfrog), "yfrog"));
		specs.add(new ImageUploaderSpec(getContext().getString(R.string.image_uploader_imgly), "imgly"));
		specs.add(new ImageUploaderSpec(getContext().getString(R.string.image_uploader_moby), "moby"));
		specs.add(new ImageUploaderSpec(getContext().getString(R.string.image_uploader_lockerz), "lockerz"));
