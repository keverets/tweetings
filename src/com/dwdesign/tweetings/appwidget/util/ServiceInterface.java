...
import static com.dwdesign.tweetings.appwidget.util.ServiceUtils.bindToService;
...
public final class ServiceInterface implements Constants, ITweetingsService {
	...
	private ServiceInterface(final Context context) {
		...
		intent.setPackage(TWEETINGS_PACKAGE_NAME);
	...
	@Override
	public String generateOAuthEchoHeader(long account_id)
	...
	@Override
	public int scheduleStatus(String schedule_date, long[] account_ids,
			String content, Location location, Uri image_uri, long in_reply_to,
	...
	@Override
	public int bufferStatus(long[] account_ids, String content) throws RemoteException {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public int insertStreamToHomeTimeline(long account_id, Intent intent)
			throws RemoteException {
		// TODO Auto-generated method stub
		return 0;
	}
	...
	@Override
	public int insertStreamToMentions(long account_id, Intent intent)
			throws RemoteException {
		// TODO Auto-generated method stub
		return 0;
	}
	...
	@Override
	public int insertStreamToInbox(long account_id, Intent intent)
			throws RemoteException {
		// TODO Auto-generated method stub
		return 0;
	}
