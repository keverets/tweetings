...
import static com.dwdesign.tweetings.util.Utils.getImageMimeType;

import java.io.File;
import java.io.IOException;

import com.dwdesign.tweetings.R;
import com.dwdesign.tweetings.fragment.ProgressDialogFragment;
...
public class SaveImageTask extends AsyncTask<Void, Void, File> implements Constants {
	...
	public static File saveImage(final Context context, final File image_file) {
		...
		try {
			...
			final File save_dir = new File(pub_dir, "Tweetings");
