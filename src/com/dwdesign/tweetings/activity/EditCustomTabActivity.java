...
import static com.dwdesign.tweetings.util.Utils.CUSTOM_TABS_ICON_NAME_MAP;
import static com.dwdesign.tweetings.util.Utils.CUSTOM_TABS_TYPE_NAME_MAP;
import static com.dwdesign.tweetings.util.Utils.buildArguments;
	...
	private void setPreferencesByType(final String type) {
		...
		if (AUTHORITY_LIST_TIMELINE.equals(type) || AUTHORITY_LIST_MEMBERS.equals(type)
			...
			mText1Preference.setShouldCompleteUserName(false);
				...
				|| AUTHORITY_DIRECT_MESSAGES.equals(type) || AUTHORITY_TRENDS.equals(type) || AUTHORITY_NEARBY.equals(type)) {
