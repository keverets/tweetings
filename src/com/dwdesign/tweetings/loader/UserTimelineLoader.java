...
public class UserTimelineLoader extends Twitter4JStatusLoader {
	...
	public UserTimelineLoader(final Context context, final long account_id, final long user_id, final String user_screenname, final long max_id, final long since_id,
	...
	public ResponseList<Status> getStatuses(final Paging paging) throws TwitterException {
		...
		if (mUserId != -1) {
			...
			if (mPreferences.getBoolean(PREFERENCE_KEY_API_V1, true) == true) {
				return mTwitter.getUserTimelinev1(mUserId, paging);
			}
