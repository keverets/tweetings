...
public class UserRetweetedStatusLoader extends Twitter4JStatusLoader {

	private final long mStatusId;
	private final Context mContext;

	public UserRetweetedStatusLoader(final Context context, final long account_id, final long status_id, long max_id, long since_id, List<ParcelableStatus> data, String class_name, boolean is_home_tab) {
	...
	public ResponseList<Status> getStatuses(final Paging paging) throws TwitterException {
		...
		if (mStatusId > 0)
			return mTwitter.getRetweets(mStatusId);
		return null;
	}
	...
	public static void writeSerializableStatuses(final Object instance, final Context context, 
		...
		try {
			...
			final String path = SerializationUtil.getSerializationFilePath(context,
					instance.getClass().getSimpleName(), account_id, status_id);
